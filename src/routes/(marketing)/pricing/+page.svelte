...
<div class="min-h-[70vh] pb-8 mt-24 pt-[5vh] px-4">
  ...
  <h2 class="text-xl text-center mt-1 pb-3 text-muted-foreground tracking-wide">
    If you want to fast track yourself to more features <a
      href="/#cal"
      class="text-primary hover:underline">book a call</a
    > with one of our founders.
  </h2>

  <div class="w-full my-8">
    <PricingModule callToAction="Start Now" highlightedPlanId="pro" />
